...
export const scheduleRoutes = new Elysia({ prefix: "/schedule" })
  ...
  .post("/:type", async ({ params, body }: { params: any; body: any }) => scheduleController.createSchedule({ ...body, type: params.type }), { tags: ["Schedule"] })
  ...
  .get("/search/:query", async ({ params, query }: { params: any; query: any }) => scheduleController.searchSchedules(params.query, query.user_id), { tags: ["Schedule"] })
